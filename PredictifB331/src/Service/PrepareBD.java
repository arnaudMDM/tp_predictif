...
public class PrepareBD
{
    ...
    public void populate()
    {
        ...
        employes.add(createEmploye("Thibaut", "Bernard", "a"));
        employes.add(createEmploye("Boris", "Aloin", "a"));
        employes.add(createEmploye("Jean", "Durand", "a"));
        employes.add(createEmploye("Jean", "Dupond", "a"));
        employes.add(createEmploye("Gosouep", "Dasilva", "a"));
        employes.add(createEmploye("Icare", "Rodriguez", "a"));
    ...
    public void addClients()
    {
        ...
        service.createClient("fouchet", "pierre", "rue titi\n69000 Lyon", "jean@email", "0665642480", calendar,mediums, employes.get(0));
